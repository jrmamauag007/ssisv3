...
class StudentModel:
    ...
    def get_students(cls):
        ...
        cursor.execute("SELECT * FROM Students JOIN Courses on Students.coursecode = Courses.coursecode JOIN Colleges on Courses.collegecode = Colleges.collegecode ORDER BY id ASC")
